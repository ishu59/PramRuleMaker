...
# whenever we see combination of a, b, c in any order we expect to get a combination of d, e in any order
# {a , b, c} => {d, e}
...
class RuleGenerator:
    ...
    def write_rules(self, filename, filetype='txt'):
        '''
