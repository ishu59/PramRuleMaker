...
class PRAMClassGenerator:
    ...
    def __init__(self, json_str: object = None, json_file_path: object = None) -> None:
        """
        Accepts pram json file path or pram json as string
        :param json_str:
...
def test_simple_sir_gender():
    pcg = PRAMClassGenerator(json_file_path='jsonData/new_rule.json')
    pcg.generate_class_from_json(data=None, output_file='SIRGender', output_file_path='./sim')


if __name__ == '__main__':
    print('======================== Running Program =====================================')
    test_simple_sir_gender()
    # test_hd_rule()
    # test_simple_SIR()